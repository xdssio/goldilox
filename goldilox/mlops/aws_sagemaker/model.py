...
class GoldiloxPredictor(Predictor):
    ...
    def __init__(
        ...
        """Initialize an ``GoldiloxPredictor``.
        ...
        """
        super(GoldiloxPredictor, self).__init__(
            endpoint_name,
            sagemaker_session,
...
class GoldiloxModel(FrameworkModel):
    """A Goldilox SageMaker ``Model`` that can be deployed to a SageMaker ``Endpoint``."""

    _framework_name = "goldilox"
    ...
    def __init__(
            ...
            predictor_cls: callable = GoldiloxPredictor,
            model_server_workers: Optional[Union[int, PipelineVariable]] = None,
            **kwargs,
    ):
        """Initialize a GoldiloxModel.
    ...
    def deploy(
        ...
        return super(GoldiloxModel, self).deploy(
    ...
    def register(
        ...
        return super(GoldiloxModel, self).register(
            content_types,
            response_types,
            inference_instances,
            transform_instances,
